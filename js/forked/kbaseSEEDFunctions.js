    ...
    SEEDTree:{},
        ...
        */
        loadSEEDHierarchy: function() {
            ...
            d3.text("ui-common/functional-site/assets/data/subsys.txt", function(text) {
        ...
        update: function(source) {
            ...
            var nodeEnter = node.enter().append("g")
                ...
                .on("mouseover", function(d) {
                    ...
                    d3.select(this).append("path")          // attach a path
                        .style("stroke", "black")  // colour the line
                        .style("fill", "black")     // remove any fill colour
                        .attr("d", "M 680,0, L 683,4, L 686,0 Z")
                        .attr('class', 'triangle'); 
                })
        ...
        click: function(d) {
            ...
            //var winPop = window.open("http://narrative.kbase.us/functional-site/#/genes/" + this.options.wsNameOrId + "/" + this.options.objNameOrId + "/" + d.name);
            //}
